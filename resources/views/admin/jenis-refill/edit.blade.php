<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-3xl font-black text-gray-900 tracking-tight">Edit Jenis Refill</h2>
                <p class="text-sm text-gray-500 font-medium">Perbarui data jenis refill: {{ $jenisRefill->nama }}</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="bg-amber-50 border border-amber-100 rounded-2xl p-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-amber-700 mt-1">Halaman ini tidak mengubah stok. Harga standar yang diperbarui di sini akan dipakai untuk transaksi pembelian refill berikutnya.</p>
                        </div>
                    </div>
                </div>
