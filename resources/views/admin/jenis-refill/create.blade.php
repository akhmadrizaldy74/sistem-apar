<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-3xl font-black text-gray-900 tracking-tight">Tambah Jenis Refil</h2>
                <p class="text-sm text-gray-500 font-medium">Buat jenis refil baru untuk dipakai di sistem</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="bg-amber-50 border border-amber-100 rounded-2xl p-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-amber-700 mt-1">Master data jenis refil hanya menyimpan nama, satuan, dan harga standar. Stok dikelola melalui menu <strong>Pengeluaran</strong> dan dipantau di menu <strong>Stok</strong>.</p>
                        </div>
                    </div>
                </div>
