<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-3xl font-black text-gray-900 tracking-tight">Tambah Media Refill</h2>
                <p class="text-sm text-gray-500 font-medium">Buat kategori media pengisian ulang APAR baru</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
            <form action="{{ route('admin.jenis-refill.store') }}" method="POST" class="p-12 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        <label for="stok" class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2">Stok Awal</label>
                        <input type="number" step="0.1" name="stok" id="stok" value="{{ old('stok', 0) }}" required
                    ...
                    <div>
                        ...
                        <input type="number" step="0.1" name="stok_minimum" id="stok_minimum" value="{{ old('stok_minimum', 5) }}" required
                            class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-red-600/20 font-bold text-gray-900 transition">
