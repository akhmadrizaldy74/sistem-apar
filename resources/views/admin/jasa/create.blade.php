<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-3xl font-black text-slate-900 tracking-tight">Tambah Jasa Layanan</h2>
                <p class="text-sm text-slate-500 font-semibold">Isi data jenis jasa / perbaikan baru yang ditawarkan ke pelanggan.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="max-w-3xl">
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
            <form action="{{ route('admin.jasa.store') }}" method="POST" class="p-8 sm:p-12 space-y-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="500" name="harga" id="harga" value="{{ old('harga') }}" required min="0"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                            ...
                            placeholder="Jelaskan cakupan perbaikan atau penggantian sparepart yang dikerjakan...">{{ old('deskripsi') }}</textarea>
