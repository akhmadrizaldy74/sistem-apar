    ...
    <div class="space-y-8">
        <form method="GET" class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 grid md:grid-cols-4 gap-4 items-end">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('admin.laporan.apar.csv', request()->query()) }}" class="flex-1 px-6 py-4 bg-emerald-600 text-white font-black rounded-2xl hover:bg-emerald-700 transition uppercase tracking-widest text-xs text-center">
                    CSV
                </a>
            </div>
        </form>
