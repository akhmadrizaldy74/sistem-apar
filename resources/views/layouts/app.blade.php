                ...
                <nav class="flex-grow space-y-1 overflow-y-auto no-scrollbar px-2 py-4 sm:px-3 lg:px-0">
                    ...
                    @else
                        ...
                        <div class="sidebar-group-wrap px-4 pt-4 pb-1">
                            <p class="sidebar-group-label text-[9px] font-black text-slate-600 uppercase tracking-widest">Penjualan</p>
                        </div>
                        ...
                        <x-nav-link-sidebar :href="route('admin.pelanggan.index')" :active="request()->routeIs('admin.pelanggan.*')" class="sidebar-nav-link">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-1a4 4 0 00-5-3.874M17 20H7m10 0v-1c0-.804-.12-1.581-.344-2.313M7 20H2v-1a4 4 0 015-3.874M7 20v-1c0-.804.12-1.581.344-2.313m0 0a5 5 0 019.312 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                        ...
                        <div x-data="{ open: {{ request()->routeIs('admin.jenis-apar.*', 'admin.jenis-refill.*', 'admin.peralatan.*', 'admin.service-paket.*', 'admin.jasa.*') ? 'true' : 'false' }} }" class="sidebar-group-wrap relative">
                            ...
                            <div x-show="open" class="flex flex-col pl-12 pr-4 py-1 space-y-1 bg-slate-900/50">
                                ...
                                <a href="{{ route('admin.jasa.index') }}" class="text-xs font-semibold py-2 px-3 rounded-lg transition {{ request()->routeIs('admin.jasa.*', 'admin.service-paket.*') ? 'text-red-400 bg-slate-800' : 'text-slate-400 hover:text-white hover:bg-slate-800' }}">Manajemen Jasa</a>
                                <a href="{{ route('admin.peralatan.index') }}" class="text-xs font-semibold py-2 px-3 rounded-lg transition {{ request()->routeIs('admin.peralatan.*') ? 'text-red-400 bg-slate-800' : 'text-slate-400 hover:text-white hover:bg-slate-800' }}">Peralatan</a>
                            </div>
                        </div>

                        {{-- Group: PEMBELIAN --}}
                        <div class="sidebar-group-wrap px-4 pt-4 pb-1">
                            <p class="sidebar-group-label text-[9px] font-black text-slate-600 uppercase tracking-widest">Pembelian</p>
                        </div>
                        <x-nav-link-sidebar :href="route('admin.suppliers.index')" :active="request()->routeIs('admin.suppliers.*')" class="sidebar-nav-link">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5m0 0h4m-4 0v-4a1 1 0 011-1h2a1 1 0 011 1v4m-6 0h6" /></svg>
                            <span class="sidebar-label truncate">SUPPLIER</span>
                        </x-nav-link-sidebar>
                        <x-nav-link-sidebar :href="route('admin.purchase-orders.index')" :active="request()->routeIs('admin.purchase-orders.*')" class="sidebar-nav-link">
