...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased overflow-hidden">
        <div class="min-h-screen flex items-center justify-center auth-bg p-6 relative">
            ...
            <div class="w-full max-w-md">
                <!-- Branding -->
                <div class="text-center mb-10 relative" data-reveal>
                ...
                <!-- Auth Card -->
                <div class="bg-white/90 backdrop-blur-2xl p-10 rounded-[2.5rem] shadow-2xl shadow-black/40 border border-white/15 relative" data-reveal>
                    {{ $slot }}
                </div>
                
                <!-- Footer Info -->
                <p class="mt-8 text-center text-xs font-bold text-white/50 uppercase tracking-[0.15em] relative" data-reveal>
